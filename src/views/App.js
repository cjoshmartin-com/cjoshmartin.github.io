...
export default class App extends Component {
    ...
    constructor(prop) {
        ...
        this.state = {
            ...
            links: {
                resume: "",
                github: "https://api.github.com/repos/cjoshmartin/cjoshmartin.github.io",
        ...
        await axios.get(`https://api.github.com/repos/cjoshmartin/cjoshmartin.github.io`)
            .then(res => {
                this.setState({
                    github: {
                        website: {
                            last_updated: moment(res.data.pushed_at, "YYYY-MM-DDThh:mm:ssZ").fromNow()
                        }
                    }
                }
                )
