...
<html lang="en">
<head>
    <title>Code coverage report for juice\lib\juice.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">juice\lib\juice.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.49% <small>(120 / 127)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">79.17% <small>(38 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">juice\lib\</a> &#187; juice.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
var juice = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error("The juice() function has been removed; use juice.juiceDocument, juice.juiceFile, or juice.juiceContent.");</span>
};
&nbsp;
...
&nbsp;
  function setStyleAttrs(el) {
    ...
    style = style.sort( function ( a, b )
    {
      var aProp = a.split( ':' )[0];
      var bProp = b.split( ':' )[0];
      return ( aProp &gt; bProp ? 1 : aProp &lt; bProp ? -1 : <span class="branch-1 cbranch-no" title="branch not covered" >0 </span>);
    } );
...
&nbsp;
  function setWidthAttrs(el) {
    ...
    if (juice.widthElements.indexOf(elName) &gt; -1) {
      for (var i in el.styleProps) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (el.styleProps[i].prop === 'width' &amp;&amp; el.styleProps[i].value.match(/px/)) {
...
function juiceFile(filePath, options, callback) {
  ...
  fs.readFile(filePath, 'utf8', function(err, content) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if(!options.relativeTo){
...
function getStylesData($, options) {
  ...
  stylesList.each(function () {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (styleDataList.length !== 1) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    styleData = styleDataList[0].data;
    <span class="missing-if-branch" title="else path not taken" >E</span>if ( options.applyStyleTags ) results.push( styleData );
    <span class="missing-if-branch" title="else path not taken" >E</span>if ( options.removeStyleTags )
    {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Feb 10 2015 13:43:01 GMT-0600 (Central Standard Time)</div>
</div>
